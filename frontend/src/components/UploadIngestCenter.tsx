            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full bg-white dark:bg-[#0E1626] border border-stone-300 dark:border-slate-700/80 rounded-xl px-3 py-2 text-xs font-num text-slate-900 dark:text-slate-100 placeholder:text-stone-400 focus:outline-none focus:border-amber-500 shadow-xs"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-white dark:bg-[#0E1626] border border-stone-300 dark:border-slate-700/80 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-slate-100 focus:outline-none focus:border-amber-500 shadow-xs"
                >
